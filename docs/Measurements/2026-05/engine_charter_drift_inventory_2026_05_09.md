...
**Bottom line:** Of 6 engines, only Engine C.1 (Ledger) and Engine F are operating close to charter. C.2 is the most severe gap — defined but never invoked in production. The substrate-honest 0.507 result was generated by a system where 4 of 6 engines have meaningful charter drift.
